...
const consoleDescriptions: Record<string, string> = {
  ...
  "gb": "1989年に任天堂が発売した携帯型ゲーム機。ポケットモンスターの大ヒットで社会現象を起こし、カラー版を含め全世界で約1冄2千800万台を販売した。",
  ...
  "nds": "2004年に任天堂が発売したデュアルスクリーン搭載の携帯型ゲーム機。タッチ操作を導入し、脳トレやどうぶつの森など新ジャンルを開拓。全世界で約1冄5400万台を販売。",
  ...
  "ps2": "2000年にソニーが発売した家庭用ゲーム機。DVD再生機能を搭載し、史上最も売れたゲーム機として全世界約1傄5500万台を記録。ドラゴンクエストVIII、ファイナルファンタジーXなど名作多数。",
  ...
  "neogeo": "1990年にSNKが発売したアーケード品質の家庭用ゲーム機。本体・ソフトとも高額だが、KOF、餌狼伝説、サムライスピリッツなど格闘ゲームの名作が揃う。",
